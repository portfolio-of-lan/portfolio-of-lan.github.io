...
Press <font color=Crimson><b><i>WASD</font color=Crimson><b><i> to move, and press <font color=Crimson><b><i>J` or `K` to attack. If you need to restart, just press `R`. Press `Q` to quit the game.
