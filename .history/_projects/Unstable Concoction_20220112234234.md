...
<p class="text-centerfont color=color:DarkGrey">
---
</p>
...
+ the <font color=color:DeepSkyBlue">Arcane</p>

+ the <font color=color:FireBrick">Blight</p>

+ the <font color=color:DeepPink">Crystal</p>

+ the <font color=color:DarkMagenta">Diffusal</p>

+ the <font color=color:Gold">Essence</p>

+ the <font color=color:DarkSeaGreen">Force</p>
