...
+ the <p style="color:DeepSkyBlue">Arcane</p>

+ the <p style="color:FireBrick">Blight</p>

+ the <p style="color:DeepPink">Crystal</p>

+ the <p style="color:DarkMagenta">Diffusal</p>

+ the <p style="color:Gold">Essence</p>

+ the <p style="color:DarkSeaGreen">Force</p>
