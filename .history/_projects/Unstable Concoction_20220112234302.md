...
<p class="text-centerfont color=DarkGrey">
---
</p>
...
+ the <font color=DeepSkyBlue">Arcane</p>

+ the <font color=FireBrick">Blight</p>

+ the <font color=DeepPink">Crystal</p>

+ the <font color=DarkMagenta">Diffusal</p>

+ the <font color=Gold">Essence</p>

+ the <font color=DarkSeaGreen">Force</p>
