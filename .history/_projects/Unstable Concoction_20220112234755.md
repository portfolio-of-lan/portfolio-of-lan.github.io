...
You can <font color=DodgerBlue>**_click_**</font> the ground to move the character. <font color=DodgerBlue>**_If the destination is not reachable, the movement will be forbidden_**.
